...
var _emailService = _interopRequireDefault(require("./emailService.js"));
...
var checkRequiredFields = function checkRequiredFields(inputData) {
  var arr = ["doctorId", "contentHTML", "contentMarkdown", "action", "selectedPrice", "selectedPayment", "selectedProvince", "nameClinic", "addressClinic", "note", "specialtyId"];
  var isValid = true;
  var element = "";
...
var getInforDoctorById = function getInforDoctorById(id) {
  return new Promise( /*#__PURE__*/function () {
...
var getMarkdownByDoctorId = function getMarkdownByDoctorId(id) {
  return new Promise( /*#__PURE__*/function () {
        ...
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 5:
            ...
            if (schedule && schedule.length > 0) {
              schedule = schedule.map(function (i) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 7:
            ...
            resolve({
              errCode: 0,
              errMessage: "OK getListPatientForDoctor ",
              data: data
            });
          case 9:
            _context10.next = 14;
...
var sendConfirmedExamination = function sendConfirmedExamination(data) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 14:
            resolve({
              errCode: 0,
              errMessage: "OK sendConfirmedExamination"
            });
          case 15:
            _context11.next = 20;
            break;
